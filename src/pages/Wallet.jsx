                ...
                <div className='walletForms'>
                    <div style={{ width: '100%' }} className="mb-4 border p-3 rounded-3">
                        ...
                        <div style={{ textAlign: 'end' }}>
                            <Button className='btn btn-primary'>ငွေသွင်းမည်</Button>
                        </div>
                    ...
                    <div style={{ width: '100%' }} className="mb-4 border p-3 rounded-3">
                        ...
                        <div style={{ textAlign: 'end' }}>
                            <Button className='btn btn-primary'>ငွေထုတ်မည်</Button>
                        </div>
                    ...
                    <div style={{ width: '100%' }} className="mb-4 border p-3 rounded-3">
                        ...
                        <div style={{ textAlign: 'end' }}>
                            <Button className='btn btn-primary'>တင်သွင်းမည်</Button>
                        </div>
